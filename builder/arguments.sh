...
function ze_arguments_usage() 
{
    ...
    echo ""
    echo "Toolchains:"
    echo "  gcc6 gcc7 gcc8 gcc9 gcc10 gcc11"
    echo "  clang7 clang8 clang9 clang10 clang11 clang12"
    echo "  msvc11 msvc12 msvc13 msvc14 msvc141 msvc142 msvc143"
    echo ""
    echo "Notes:"
...
function ze_arguments_parse()
{
    ...
    if [[ $ZE_BUILD_TYPE != "release" ]] && [[ $ZE_BUILD_TYPE != "debug" ]]; then
